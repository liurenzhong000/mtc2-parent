...
public class Constants {
    ...
    public enum Tag {
        ...
        // omni钱包的币种的业务发起
        ,OMNI_BIZ_TRANS_PENDING("PID_bhb_biz_trans", "CID_BHB_OMNI_BIZ_TRANS_PENDING", "GID_OMNI_BIZ_TRANS_PENDING")
        // omni钱包的币种的业务完成
        ,OMNI_BIZ_TRANS_COMPLETE("PID_bhb_biz_trans", "CID_BHB_OMNI_BIZ_TRANS_COMPLETE", "GID_OMNI_BIZ_TRANS_COMPLETE")
        ,OMNI_BIZ_HOST_WALLET_TRANS("PID_bhb_biz_trans", "CID_BHB_OMNI_BIZ_HOST_WALLET_TRANS", "GID_OMNI_BIZ_HOST_WALLET_TRANS")
//        ,OMNI_BIZ_HOST_WALLET_TRANS_COMPLETE("PID_bhb_biz_trans", "CID_BHB_OMNI_BIZ_HOST_WALLET_TRANS_COMPLETE", "GID_OMNI_BIZ_HOST_WALLET_TRANS_COMPLETE")
        ;
